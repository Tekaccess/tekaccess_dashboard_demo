    ...
    <div className="bg-card rounded-xl border border-[var(--border)] p-6 flex flex-col h-full">
      ...
      <div className="mb-4">
        ...
        <div className="flex justify-between items-end">
          ...
          <select className="text-xs border border-[var(--border)] rounded-lg px-2 py-1 bg-surface text-t2 outline-none">
            <option>Jan 1-Aug 30</option>
          </select>
        </div>
      </div>

      <button className="w-full flex items-center justify-between px-4 py-3 bg-surface hover:bg-surface-hover border border-[var(--border)] rounded-xl mb-8 transition-colors">
      ...
      <div className="flex-1 flex flex-col justify-end">
        ...
        <div className="flex items-center justify-between text-xs text-t3 pt-4 border-t border-dashed border-[var(--border)]">
          <span>1 jan</span>
